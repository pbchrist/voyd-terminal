# Mutation Designer / Implementation / Replay

## Mutation Designer
Given only the governing diagnosis, produce 2-4 genuinely different structural repairs when alternatives are warranted. Each proposal must state: structural change -> story consequence -> price/risk. Respect Story Physics, genome, and immutable canon.
